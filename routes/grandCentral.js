...
module.exports = function (app, passport) {
    ...
    app.get('/auth/google', passport.authenticate('google', { scope: configAuth.googleAuth.scope }));
    ...
    // send to google to do the authentication
    app.get('/connect/google', passport.authorize('google', { scope: configAuth.googleAuth.scope }));
